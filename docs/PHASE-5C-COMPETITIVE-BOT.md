...
| **5C-5** | Human playtest + feel pass | ~0.5 d | Playtest checklist: bot visibly hunts / targets leader / traps at least once per game vs Pro · **user sign-off**. **✅ SIGNED OFF 2026-08-16** after the 5C-7 rebalance (third playtest). Phase merged to `main` at `ce4111e`. Findings B-1..B-4 and fixes 5C-6/5C-7 recorded below |
